...
use crate::vectors::U32Vec2;
use crate::vectors::{U8Vec2, U16Vec2};
...
impl From<U8Vec2> for MortonU16{
...
impl From<U16Vec2> for MortonU32 {
...
impl MortonU64 {
    ...
    pub fn decode_xy(&self) -> U32Vec2 {
        U32Vec2::new(self.x(), self.y())
    }
}