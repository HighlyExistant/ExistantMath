use crate::{Addition, Identity, Multiplication};
...
/// [`f32`], [`f64`]
pub trait FloatingPoint: Number + FloatConsts + Signed + FromPrimitive + UniversalOperationsOn<Self> {
    fn acos(self) -> Self;
    fn acosh(self) -> Self;
    fn asin(self) -> Self;
    fn asinh(self) -> Self;
...
impl FloatingPoint for f32 {
    ...
    fn recip(self) -> Self {
        <f32 as Identity<Multiplication>>::IDENTITY/self
    }
    fn round(self) -> Self {
...
impl FloatingPoint for f64 {
    ...
    fn recip(self) -> Self {
        <f64 as Identity<Multiplication>>::IDENTITY/self
    }
    fn round(self) -> Self {
